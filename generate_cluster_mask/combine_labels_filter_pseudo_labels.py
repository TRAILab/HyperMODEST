...
def main(args: DictConfig):
    ...
    # Look through all detections, create a list that contains scores for all detections.
    all_scores=np.array([])
    ...
    for idx, det_bbox in zip(tqdm(idx_list), det_bboxes):
        ...
        det_obj = list(filter(
            ...
            (obj.score > score_threshold),     # Filter the pseudo-labels based on the computed score threshold.
